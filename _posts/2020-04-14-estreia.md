...
<br>
<!-- The text field -->
<input type="text" value="PT50001800035033421802012" id="myInput"> 
...
<div class="post-container">
  ...
  <div class="post-thumb"><img src="https://teia19.github.io/teia19/assets/images/mbway.png" width="42" height="42" /></div>
  <!-- The text field -->
  <input type="text" value="912247772" id="myInput">
  <!-- The button used to copy the text -->
  <button class="btn info" onclick="myFunction()">Copiar numero de MBWAY 📋</button>
  </div>  
</div>
