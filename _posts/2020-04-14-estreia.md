...
<div>
    ...
    <p class="iban">PT50001800035033421802012       |        NOME: André Gago</p>

<!-- The text field -->
<input type="text" value="PT50001800035033421802012" id="myInput"> Nome: xxxx
<!-- The button used to copy the text -->
<button class="btn success" onclick="myFunction()">Copiar numero de IBAN 📋</button>
